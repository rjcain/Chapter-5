...
public class ProcessTransactions
{
    public static void main(String[] args){
        ...
        System.out.println(acct1.getNumDeposits());
        System.out.println(acct2.getNumDeposits());
        System.out.println(acct1.getNumWithdrawals());
        System.out.println(acct2.getNumWithdrawals());
    }
}